...
<input type="hidden" name="e" value="tambahKat">

<table  style="background-color:#FFF">
<tr><td style="background-color: #FFF">Nama Kategori</td><td>:</td><td style="background-color: #FFF"> <input name="namaKat" type="text" size="54"	 required="required" /></td></tr>
<tr><td></td><td></td><td>
<input type="submit" value="Tambah" align="middle" /></form></td></tr>
</table>
</div>
