...
<div class="container"><h1 align="center">Pesan Terkirim</h1>
<table border="2px" bgcolor="#00FFFF">
<?php
$allpost=mysql_query("SELECT * FROM pesan where sender='$_SESSION[u]'  ORDER BY date DESC");
while($datapost=mysql_fetch_array($allpost)){
	$nama=mysql_fetch_array(mysql_query("SELECT * FROM user where username='$datapost[receiver]'"));
	$xxx=$nama['avatar'];
	echo("<tr><td width=\"50\"><a href=\"profil.php?user=$datapost[receiver]\"><img src='$xxx' width=\"50\" height=\"50\"></a>");
	echo "".$nama['nama']."<br>";
