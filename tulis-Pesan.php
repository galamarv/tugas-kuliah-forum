...
<?php
if($_GET['e']=="balas"){?><table>
<form method="post" action="proses-Login.php">
<input type="hidden" name="e" value="pesan" />
<tr><td>Kirim ke</td><td>:</td><td><input type="text" name="receiver" size="30" value="<?php echo $_GET['receiver']; ?>" required="required" /></td></tr>
<tr><td><br /></td><td></td><td></td></tr>
<tr><td>Pesan</td><td>:</td><td><textarea name="pesan" cols="26"></textarea></td></tr>
<tr><td><br /></td><td></td><td></td></tr>
...
<form method="post" action="proses-Login.php">
<input type="hidden" name="e" value="pesan" />
<tr><td>Kirim ke</td><td>:</td><td><input type="text" name="receiver" size="30" required="required"  /></td></tr>
<tr><td><br /></td><td></td><td></td></tr>
<tr><td>Pesan</td><td>:</td><td><textarea name="pesan" cols="26"></textarea></td></tr>
<tr><td><br /></td><td></td><td></td></tr>
<tr><td></td><td></td><td><input type="submit" value="Kirim" /></td></tr>
